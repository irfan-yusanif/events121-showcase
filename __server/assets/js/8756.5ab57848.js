...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(30756);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(75937);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(25582);
...
var ErDB = class {
  constructor() {
    ...
    this.setAccTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setAccTitle */ .SV;
    this.getAccTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getAccTitle */ .iN;
    this.setAccDescription = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setAccDescription */ .EI;
    this.getAccDescription = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getAccDescription */ .m7;
    this.setDiagramTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setDiagramTitle */ .ke;
    this.getDiagramTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getDiagramTitle */ .ab;
    this.getConfig = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(() => (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)().er, "getConfig");
    this.clear();
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(this, "ErDB");
  }
  /**
   * Add entity
  ...
  addEntity(name, alias = "") {
    if (!this.entities.has(name)) {
      this.entities.set(name, {
        ...
        alias,
        shape: "erBox",
        look: (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)().look ?? "default",
        cssClasses: "default",
        cssStyles: []
      });
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log */ .Rm.info("Added new entity :", name);
    } else if (!this.entities.get(name)?.alias && alias) {
      this.entities.get(name).alias = alias;
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log */ .Rm.info(`Add alias '${alias}' to entity '${name}'`);
    }
  ...
  addAttributes(entityName, attribs) {
    ...
    for (i = attribs.length - 1; i >= 0; i--) {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log */ .Rm.debug("Added attribute ", attribs[i].name);
    }
  }
  /**
   * Add a relationship
  ...
  addRelationship(entA, rolA, entB, rSpec) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log */ .Rm.debug("Added new relationship :", rel);
  }
  getRelationships() {
  ...
  clear() {
    ...
    this.classes = /* @__PURE__ */ new Map();
    this.relationships = [];
    (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .clear */ .IU)();
  }
  getData() {
    const nodes = [];
    const edges = [];
    ...
    for (const relationship of this.relationships) {
      const edge = {
        id: (0,_chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getEdgeId */ .rY)(relationship.entityA, relationship.entityB, {
          prefix: "id",
          counter: count++
        }),
        type: "normal",
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__export */ .VA)(erRenderer_unified_exports, {
  draw: () => draw
});

var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(async function(text, id, _version, diag) {
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log */ .Rm.info("REF0:");
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log */ .Rm.info("Drawing er diagram (unified)", id);
  const { securityLevel, er: conf, layout } = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramElement */ .A)(id, securityLevel);
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  ...
  if (Array.from(backgroundNodes).length > 0) {
    backgroundNodes.each(function() {
      const backgroundNode = (0,d3__WEBPACK_IMPORTED_MODULE_12__/* .select */ .Ltv)(this);
  ...
  const padding = 8;
  _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default */ ._K.insertTitle(
    svg,
    "erDiagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, padding, "erDiagram", conf?.useMaxWidth ?? true);
}, "draw");

// src/diagrams/er/styles.ts

var fade = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)((color, opacity) => {
  const channel2 = khroma__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .A;
