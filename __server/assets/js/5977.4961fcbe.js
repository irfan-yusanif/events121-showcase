...
/* harmony import */ var _index_7b89c939_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74157);
/* harmony import */ var _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26468);
/* harmony import */ var _user_prefs_47572e95_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(55055);
...
const DyteSettings = class {
  ...
  close() {
    ...
    _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSettings = false;
  }
  render() {
    ...
    return ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("aside", { class: { hide: this.isMobileMainVisible }, part: "menu" }, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, this.t('settings'))), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: { active: this.activeTab === 'audio' }, onClick: () => this.changeTab('audio') }, this.t('audio'), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.mic_on, iconPack: this.iconPack, t: this.t }), this.size === 'sm' && ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_right, iconPack: this.iconPack, t: this.t })))), this.canProduceVideo && ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: { active: this.activeTab === 'video' }, onClick: () => this.changeTab('video') }, this.t('video'), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.video_on, iconPack: this.iconPack, t: this.t }), this.size === 'sm' && ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_right, iconPack: this.iconPack, t: this.t }))))), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "none", title: `Your network condition is ${this.networkStatus}` }, this.t('connection'), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.wifi, class: this.networkStatus, iconPack: this.iconPack, t: this.t })))), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("main", { class: { active: this.isMobileMainVisible, scrollbar: true }, part: "main-content" }, this.size === 'sm' && ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", class: "back-btn", onClick: () => (this.isMobileMainVisible = false), iconPack: this.iconPack, t: this.t }, (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_left, iconPack: this.iconPack, t: this.t })), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, this.t(this.activeTab === 'audio' ? 'audio' : 'video')))), this.activeTab === 'audio' && (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-settings-audio", Object.assign({}, defaults)), this.activeTab === 'video' && (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-settings-video", Object.assign({}, defaults)))));
  }
