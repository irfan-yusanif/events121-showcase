...
var RequirementDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(() => (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)().requirement, "getConfig");
    this.clear();
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(this, "RequirementDB");
  }
  getDirection() {
  ...
  addElement(name) {
    if (!this.elements.has(name)) {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log */ .Rm.info("Added new element: ", name);
    }
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__export */ .VA)(requirementRenderer_exports, {
  draw: () => draw
});
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(async function(text, id, _version, diag) {
  ...
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log */ .Rm.info("Drawing requirement diagram (unified)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
  ...
  (0,_chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, padding, "requirementDiagram", conf?.useMaxWidth ?? true);
}, "draw");
