...
/* harmony export */ });
/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8873);
/* harmony import */ var _color_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(69047);
/* IMPORT */
...
/* harmony export */ });
/* harmony import */ var _chunk_FMBD7UC4_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(52501);
/* harmony import */ var _chunk_MI3HLSF2_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(73981);
/* harmony import */ var _chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(89625);
/* harmony import */ var _chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21152);
/* harmony import */ var _chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10045);
/* harmony import */ var _chunk_QXUST7PY_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5164);
/* harmony import */ var _chunk_HN2XXSSU_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(28698);
/* harmony import */ var _chunk_JZLCHNYA_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5894);
/* harmony import */ var _chunk_CVBHYZKI_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(63245);
/* harmony import */ var _chunk_ATLVNIR6_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(32387);
/* harmony import */ var _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(72793);
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(13226);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(77444);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(40797);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(30756);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(75937);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(25582);
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .D7)();
    ...
    this.funs = [];
    this.setAccTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setAccTitle */ .SV;
    this.setAccDescription = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setAccDescription */ .EI;
    this.setDiagramTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setDiagramTitle */ .ke;
    this.getAccTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getAccTitle */ .iN;
    this.getAccDescription = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getAccDescription */ .m7;
    this.getDiagramTitle = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getDiagramTitle */ .ab;
  ...
  static {
    (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(this, "FlowDB");
  }
  sanitizeText(txt) {
    return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .common_default */ .Y2.sanitizeText(txt, this.config);
  }
  /**
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_JZLCHNYA_mjs__WEBPACK_IMPORTED_MODULE_7__/* .isValidShape */ .aP)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.info("abc78 Got edge...", edge);
    ...
    if (id && !this.edges.some((e) => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .getEdgeId */ .rY)(edge.start, edge.end, { counter: 0, prefix: "L" });
      } else {
        edge.id = (0,_chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .getEdgeId */ .rY)(edge.start, edge.end, {
    ...
    if (this.edges.length < (this.config.maxEdges ?? 500)) {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.info("Pushing edge...");
...
You have to call mermaid.initialize.`
  ...
  addLink(_start, _end, linkData) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.info("addLink", _start, _end, id);
  ...
  setClickFun(id, functionName, functionArgs) {
    ...
    if ((0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .D7)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default */ ._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default */ ._K.formatUrl(linkStr, this.config);
  ...
  setupToolTips(element) {
    let tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_14__/* .select */ .Ltv)(".mermaidTooltip");
    if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
      tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_14__/* .select */ .Ltv)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
    }
    const svg = (0,d3__WEBPACK_IMPORTED_MODULE_14__/* .select */ .Ltv)(element).select("svg");
    const nodes = svg.selectAll("g.node");
    nodes.on("mouseover", (e) => {
      const el = (0,d3__WEBPACK_IMPORTED_MODULE_14__/* .select */ .Ltv)(e.currentTarget);
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .D7)();
    (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .clear */ .IU)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    const uniq = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)((a) => {
    ...
    let dir = result.dir;
    const flowchartConfig = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .D7)().flowchart ?? {};
    dir = dir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .D7)().direction ?? void 0 : void 0);
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
  ...
  getData() {
    const config = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .D7)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .getEdgeId */ .rY)(rawEdge.start, rawEdge.end, { counter: index, prefix: "L" }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .defaultConfig2 */ .ME.flowchart;
  }
};

// src/diagrams/flowchart/flowRenderer-v3-unified.ts

var getClasses = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(async function(text, id, _version, diag) {
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.info("REF0:");
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.info("Drawing state diagram (v2)", id);
  const { securityLevel, flowchart: conf, layout } = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getConfig2 */ .D7)();
  let sandboxElement;
  if (securityLevel === "sandbox") {
    sandboxElement = (0,d3__WEBPACK_IMPORTED_MODULE_14__/* .select */ .Ltv)("#i" + id);
  }
  const doc = securityLevel === "sandbox" ? sandboxElement.nodes()[0].contentDocument : document;
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.debug("Before getData: ");
  const data4Layout = diag.db.getData();
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.debug("Data: ", data4Layout);
  const svg = (0,_chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getDiagramElement */ .A)(id, securityLevel);
  const direction = diag.db.getDirection();
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.warn(
  ...
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log */ .Rm.debug("REF1:", data4Layout);
  await (0,_chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .render */ .XX)(data4Layout, svg);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default */ ._K.insertTitle(
    svg,
    "flowchartTitleText",
    conf?.titleTopMargin || 0,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setupViewPortForSVG */ .P)(svg, padding, "flowchart", conf?.useMaxWidth || false);
  for (const vertex of data4Layout.nodes) {
    const node = (0,d3__WEBPACK_IMPORTED_MODULE_14__/* .select */ .Ltv)(`#${id} [id="${vertex.id}"]`);
    if (!node || !vertex.link) {
      continue;
    }
...
var parser = (function() {
  var o = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 2:
          this.$ = [];
    ...
    defaultActions: {},
    parseError: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function parse(input) {
      ...
      (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ (function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)(Parser, "Parser");
...
var fade = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)((color, opacity) => {
  const channel2 = khroma__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .A;
  const r = channel2(color, "r");
  const g = channel2(color, "g");
  const b = channel2(color, "b");
  return khroma__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .A(r, g, b, opacity);
}, "fade");
var getStyles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)((options) => `.label {
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .K2)((cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    if (cnf.layout) {
      (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setConfig2 */ .XV)({ layout: cnf.layout });
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .setConfig2 */ .XV)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
  }, "init")
};
