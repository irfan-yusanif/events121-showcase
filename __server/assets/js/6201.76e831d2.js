...
/* harmony import */ var _config_5075148d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68759);
/* harmony import */ var _size_d48d31c8_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20037);
/* harmony import */ var _index_7b89c939_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74157);
/* harmony import */ var _default_ui_config_f87e0ba7_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(93514);
/* harmony import */ var _index_9bb85c23_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(17213);
/* harmony import */ var _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26468);
/* harmony import */ var _breakout_rooms_manager_7dc0174a_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(60064);
/* harmony import */ var _livestream_1a40fc8d_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(94370);
/* harmony import */ var _user_prefs_47572e95_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(55055);
/* harmony import */ var _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(79379);
/* harmony import */ var _default_icon_pack_307ffa7c_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(17073);
...
/* harmony import */ var _flags_f14ed3df_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(64383);
/* harmony import */ var _breakout_rooms_dea0806e_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(70694);
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.roomJoinedListener = () => {
      ...
      _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.meeting = 'joined';
    };
    ...
    this.waitlistedListener = () => {
      ...
      _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.meeting = 'waiting';
    };
    this.roomLeftListener = ({ state: state$1 }) => {
      const states = this.states || _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s;
      if ((states === null || states === void 0 ? void 0 : states.roomLeftState) === 'disconnected') {
        this.setStates({ meeting: 'ended', roomLeftState: state$1 });
        _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.meeting = 'ended';
        return;
      }
      this.setStates({ meeting: 'ended', roomLeftState: state$1 });
      _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.meeting = 'ended';
      _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.roomLeftState = state$1;
    };
    this.mediaPermissionUpdateListener = ({ kind, message }) => {
      if (['audio', 'video'].includes(kind)) {
        if (message === 'ACCEPTED' || message === 'NOT_REQUESTED' || _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.activeDebugger)
          return;
        ...
        _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.activePermissionsMessage = permissionModalSettings;
      }
    };
    this.joinStateAcceptedListener = () => {
      this.setStates({ activeJoinStage: true });
      this.stateUpdate.emit({ activeJoinStage: true });
      _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.activeJoinStage = true;
    };
    ...
    this.states = {
      meeting: 'idle',
      prefs: (0,_user_prefs_47572e95_js__WEBPACK_IMPORTED_MODULE_9__.g)(),
    };
    this.iconPack = _default_icon_pack_307ffa7c_js__WEBPACK_IMPORTED_MODULE_11__.d;
  }
  connectedCallback() {
    var _a;
    this.resizeObserver = new _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_10__.i(() => this.handleResize());
    this.resizeObserver.observe(this.host);
    if (this.applyDesignSystem &&
      ((_a = this.config) === null || _a === void 0 ? void 0 : _a.designTokens) != null &&
      typeof document !== 'undefined') {
      (0,_config_5075148d_js__WEBPACK_IMPORTED_MODULE_1__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_5075148d_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      ...
      if (meeting.connectedMeetings.supportsConnectedMeetings &&
        ((_a = _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.activeBreakoutRoomsManager) === null || _a === void 0 ? void 0 : _a.destinationMeetingId)) {
  ...
  async iconPackUrlChanged(url) {
    this.iconPack = await (0,_size_d48d31c8_js__WEBPACK_IMPORTED_MODULE_2__.g)(url);
  }
  listenState(e) {
    e.stopPropagation();
  ...
  handleChangingMeeting(destinationMeetingId) {
    _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.activeBreakoutRoomsManager = Object.assign(Object.assign({}, _store_8f4d7acc_js__WEBPACK_IMPORTED_MODULE_6__.s.activeBreakoutRoomsManager), { destinationMeetingId });
  }
  handleResize() {
    this.size = (0,_size_d48d31c8_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.host.clientWidth);
  }
  setStates(states) {
    const newStates = Object.assign({}, this.states);
    (0,_config_5075148d_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
  ...
  render() {
    ...
    if (((_b = (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.meta) === null || _b === void 0 ? void 0 : _b.viewType) === 'CHAT')
      return (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9bb85c23_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-chat", defaults: defaults });
    return (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9bb85c23_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-meeting", defaults: defaults, asHost: true, elementProps: elementProps });
  }
