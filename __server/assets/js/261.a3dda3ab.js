...
/* harmony import */ var _index_9bb85c23_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17213);
/* harmony import */ var _grid_cfa3c02f_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(37895);
/* harmony import */ var _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(79379);
/* harmony import */ var _string_274004ff_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1821);
...
const DyteSimpleGrid = class {
  constructor(hostRef) {
    ...
    this.onParticipantTileLoad = (event) => {
      ...
      if (!participant || !videoElement)
        return;
      (_a = this.meeting.participants.pip) === null || _a === void 0 ? void 0 : _a.addSource(participant.id, videoElement, participant.videoEnabled, false, (_b = participant.name) !== null && _b !== void 0 ? _b : (0,_string_274004ff_js__WEBPACK_IMPORTED_MODULE_7__.g)(participant.name));
  ...
  render() {
    ...
    const { width, height, getPosition } = (0,_grid_cfa3c02f_js__WEBPACK_IMPORTED_MODULE_5__.u)({
      dimensions: this.dimensions,
      count: this.participants.length,
      aspectRatio: this.aspectRatio,
      gap: this.gap,
    });
    return ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.participants.map((participant, index) => {
      const { top, left } = getPosition(index);
      return ((0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_9bb85c23_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-participant-tile", defaults: defaults, props: {
          participant,
          style: {
            position: 'absolute',
            top: `${top}px`,
    ...
    }), (0,_index_926e26e8_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
